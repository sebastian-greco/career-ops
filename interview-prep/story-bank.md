...
**A (Action):** My team built Show Notes (summaries, chapters, timestamps) and Magic Clips (viral highlights). To make it work with GPT-3, we implemented context splitting and summarization pipelines. Recognizing this would be a company-wide need, we built it as a foundational NestJS microservice that handled quota management, transcription packaging, and context window limits. We also worked closely with Product on prompt iteration. Later, we instrumented the features to capture usage data (saves, exports, votes), which we fed to our internal AI team to train a custom fine-tuned model.
...
### [Automation] Building assistants for team management and recurring personal work
**Source:** SearchApi application — Report #666; direct story capture
**S (Situation):** Team management at Riverside required keeping track of conversations, commitments, goals, engineering signals, SLA tickets, and follow-up work. Later, recurring household and healthcare administration created similar repetitive work.
**T (Task):** Build assistants that preserved context, prepared decisions, and removed repeated manual steps without handing final judgment to the automation.
**A (Action):** I built a team management assistant around Granola transcriptions, private per-person memory, Slack reminders, and a dashboard of action points, goals, issues, PRs, and commits. I also connected an SLA triage agent to Jira so it could retrieve assigned tickets, inspect code, and draft questions or possible fixes for my review. In my personal local-agent setup, I built an agent that generates and stores the cleaning person's monthly pay slip and reports the transfer amount, plus an SSN appointment agent that reads prescription photos, searches nearby provinces around my calendar preferences, and reruns the search daily when no suitable slot is available.
**R (Result):** The team assistant improved the quality of my 1:1s, made performance reviews more accurate, and increased my attention to detail and follow-through. The personal agents keep the monthly wire transfer on time and remove repeated portal work from healthcare appointment searches.
**Reflection:** The most useful automation preserves context and prepares the decision while leaving accountability with the person making it.
**Best for questions about:** automation, AI agents, engineering management, one-on-ones, performance reviews, process improvement, personal productivity, practical AI adoption

### [Leadership Judgment] Promising a successor too early and delaying a role-fit decision
**Source:** SearchApi application — Report #666; direct story capture
**S (Situation):** When I became Group Lead, I needed a successor for the Dashboard team. I had long seen one technically strong and ambitious engineer as my natural replacement. He had covered successfully during vacations and communicated well inside the team, but I gave too little weight to smaller warning signs in external stakeholder communication. During his reserve duty, a technically more experienced developer who was only about six months into Riverside served as interim lead. I doubted both his readiness as a new employee and his management skills, but he performed far better than I expected.
**T (Task):** Honor the commitment I had made, support the intended successor's transition into management, and keep an important team stable.
**A (Action):** I followed through on the original appointment when he returned under significant personal stress. His difficulties became much stronger: he became highly protective of the team, treated outside pressure as hostile, struggled to mediate or compromise, took too much on himself, and passed stress into the team instead of translating it into context and safety. I gave direct feedback and coached him over time, but waited too long to make the replacement decision. While that coaching continued, an opportunity opened to create a new team. I proposed the former interim lead and hired a team around him from scratch. When my original successor later left, that leader was already committed elsewhere, so I took direct control of the Platform team while continuing as Group Lead.
**R (Result):** I carried both roles for several months, and the departure affected the Platform team. The former interim lead built one of the strongest-performing teams in my group, confirming that I had underestimated him.
**Reflection:** Keeping my word was not the mistake. I closed my options before circumstances changed and allowed retention risk to delay a later role-fit decision. I also learned that management communication is a broad, balanced skill set: internal trust, stakeholder relationships, mediation, compromise, delegation, and translating organizational pressure into context and safety for the team. I now assess that full balance explicitly, keep succession options open, and set time-bound coaching decisions.
**Best for questions about:** misjudging a person, succession planning, leadership selection, management mistakes, difficult feedback, retention, technical-lead versus manager paths, what I would do differently
