...
export function ReportRenderer({ markdown }: { markdown: string }) {
  return (
    <div className="prose prose-zinc max-w-none break-words text-[16px]
      prose-headings:scroll-mt-20 prose-headings:font-bold prose-headings:tracking-tight
      prose-h1:text-2xl sm:prose-h1:text-3xl prose-h2:text-xl sm:prose-h2:text-2xl prose-h2:mt-8 sm:prose-h2:mt-10 prose-h2:border-b prose-h2:border-border/50 prose-h2:pb-2
      prose-h3:text-lg sm:prose-h3:text-xl prose-h3:mt-7
      ...
      prose-table:w-full prose-table:my-6 sm:prose-table:my-8 prose-table:overflow-x-auto prose-table:border-collapse prose-table:text-sm prose-table:block
